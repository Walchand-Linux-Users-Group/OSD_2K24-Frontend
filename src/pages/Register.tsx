...
const Dropdown = ({
  ...
  return (
    <div className="relative z-50 w-full">
      <div
        className="relative cursor-pointer bg-transparent border border-black rounded-md pl-10 pr-3 py-3 shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-[#FF7F50] transition duration-150 ease-in-out"
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-full bg-white rounded-md shadow-lg max-h-32 overflow-auto border border-black">
          <div className="py-1">
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-8 lg:px-10 relative overflow-hidden bg-gradient-to-b from-[#faf8f6] via-orange-100 to-[#faf8f6]">
      <motion.div
        ref={containerRef}
        className="w-full relative max-w-7xl mx-auto bg-white bg-opacity-70 backdrop-blur-md rounded-2xl shadow-2xl z-10 overflow-hidden"
        initial="hidden"
        animate={isInView ? "visible" : "hidden"}
      >
        <div className="lg:flex py-2">
          <IconCludMine />
          <motion.div className="w-full lg:w-1/2 p-6 py-8 lg:p-12 border-t lg:border-t-0 lg:border-l border-gray-200">
            <div className="mx-auto">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <motion.div key={field.name}>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        type={field.type}
                        required
                        className="block w-full pl-10 pr-3 py-3 border border-black rounded-md leading-5 text-gray-700 bg-white bg-opacity-50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 md:text-lg transition duration-150 ease-in-out"
                ...
                <motion.div>
                  <button
                    className="w-full text-lg z-0 flex justify-center py-3 px-4 border border-transparent font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition duration-150 ease-in-out transform hover:scale-105"
                    disabled={loading}
                  >
